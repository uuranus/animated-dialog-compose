...
fun DropDownDialog(
    ...
    val positionY by animateFloatAsState(
        targetValue = when (dialogState) {
            DialogState.Ready -> -screenHeight.value
            DialogState.Opening -> screenHeight.value / 2
            DialogState.Opened -> screenHeight.value / 2
            DialogState.Closing -> -screenHeight.value
            DialogState.Closed -> -screenHeight.value
        },
    ...
    Dialog(
        ...
        Box(
            modifier = Modifier
                ...
                .graphicsLayer {
                    this.translationY = positionY - size.height / 2
                    this.alpha = alpha
